...
//      setLanguage(SharedObjectManager.sharedManager().getObject("lang",Capabilities.language=="zh-CN"?'zh_CN':(Capabilities.language=="zh-TW"?'zh_TW':'en')));
		languages = [['en', 'English'],['ja', '日本語'],['ja_HIRA', 'にほんご']]; // English is always the first entry
		setLanguage(SharedObjectManager.sharedManager().getObject("lang",Capabilities.language=="ja"?'ja':(Capabilities.language=="ja"?'ja':'en')));
	}
