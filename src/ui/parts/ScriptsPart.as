...
public class ScriptsPart extends UIPart {
	...
	private var showBt:Button = new Button(Translator.map("ShowMsgBox"));
	...
	private var uploadBt2:IconButton ;
	private var backBt2:IconButton ;
	private var openBt2:IconButton

	private var currentProtchMarker:Bitmap;
	private var protchMarker:Bitmap;

	private var dialogbox2:DialogBox2 = new DialogBox2();
	...
	public function ScriptsPart(app:MBlock) {
		...
		addChild(protchMarker = new Bitmap()); //jun-ichi TAMURA 2017-11-30
		currentProtchMarker = new Bitmap();
		currentProtchMarker.bitmapData = Resources.createBmp("protchMarkerOff").bitmapData ;
		protchMarker.bitmapData = currentProtchMarker.bitmapData ;
...
//		arduinoFrame.addChild(backBt);
		...
		backBt2 = new IconButton(null, "back48", null, true);
		backBt2.x = 10;
		backBt2.y = 10;
		backBt2.addEventListener(MouseEvent.CLICK,onHideArduino);
		arduinoFrame.addChild(backBt2);
...
//		arduinoFrame.addChild(uploadBt);
		...
		uploadBt2 = new IconButton(null, "upload48", null, true);
		uploadBt2.x = 10;
		uploadBt2.y = 70;
		uploadBt2.addEventListener(MouseEvent.CLICK,onCompileArduino);
		arduinoFrame.addChild(uploadBt2);
		
		showBt.x = 10;
		showBt.y = 200;
		showBt.addEventListener(MouseEvent.CLICK,onShowMsgBox);
//		arduinoFrame.addChild(showBt);
		...
		openBt2 = new IconButton(null, "open48", null, true);
		openBt2.x = 10;
		openBt2.y = 130;
		openBt2.addEventListener(MouseEvent.CLICK,onOpenArduinoIDE);
		arduinoFrame.addChild(openBt2);
...
// jun-ichi TAMURA 2017-01-06
//		arduinoFrame.addChild(openBt); //jun-ichi TAMURA 2017-03-22 (DEBUG用)
//		arduinoFrame.addChild(arduinoTextPane);
//		arduinoFrame.addChild(messageTextPane); //jun-ichi TAMURA 2017-03-22 (DEBUG用)
...
//Debug jun-ichi TAMURA 2017-12-27		
/*
		dialogbox2.addTitle("Start Uploading");
		dialogbox2.addText("Start");
		dialogbox2.addButton("Hide",function():void{dialogbox2.cancel();});
		dialogbox2.showOnStage(MBlock.app.stage);
*/	
	...
	private function onShowMsgBox(evt:MouseEvent):void{
//		app.toggleArduinoMode();
		messageTextPane.setWidthHeight(0,0);
	}
	...
	public function updateTranslation():void{
		showBt.setLabel(Translator.map("ShowMsgBox"));
	...
	public function updateProtchMarker():void {
		protchMarker.bitmapData = currentProtchMarker.bitmapData ;
	}
	
	public function chnageOnProtch():void {
		currentProtchMarker.bitmapData = Resources.createBmp("protchMarkerOn").bitmapData ;
		protchMarker.bitmapData = currentProtchMarker.bitmapData ;
	}
	
	public function chnageOffProtch():void {
		currentProtchMarker.bitmapData = Resources.createBmp("protchMarkerOff").bitmapData ;
		protchMarker.bitmapData = currentProtchMarker.bitmapData ;	
	}
...
//		var arduinoHeight:uint = h - 10;
		var arduinoWidth:uint = app.stageIsArduino?(70):0;
		var arduinoHeight:uint = h - 10;
		...
		messageTextPane.y = 200;
		messageTextPane.setWidthHeight(arduinoWidth-messageTextPane.x,arduinoHeight-10);
...
//		protchMarker.x = w - arduinoWidth - 60;
//		protchMarker.y = scriptsFrame.y + 90;
		protchMarker.x = scriptsFrame.x + 5 ;
		protchMarker.y = scriptsFrame.y + 10 ;
