...
//				setItemLabel(item.submenu.getItemByName("Others"));
		...
		{
MBlock.app.scriptsPart.appendMessage("DBUG:__onConnect"); // jun-ichi TAMURA 2017-03-22
...
MBlock.app.scriptsPart.appendMessage("DBUG:__onConnect_onConnect"); // jun-ichi TAMURA 2017-03-22
...
MBlock.app.scriptsPart.appendMessage("DBUG:__onShowConnect"); // jun-ichi TAMURA 2017-03-22
...
//			MenuUtil.FindItem(getNativeMenu(), "Upgrade Firmware").enabled = canReset;
			MenuUtil.FindItem(getNativeMenu(), "Communication Mode").enabled = canReset;
