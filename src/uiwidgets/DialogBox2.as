...
package uiwidgets {
	...
	public class DialogBox2 extends Sprite {
		...
		private var uploadAnime:Bitmap;
		private var uploadAnime1:Bitmap;
		private var uploadAnime2:Bitmap;
		private var uploadAnime3:Bitmap;
		private var uploadAnime4:Bitmap;
		private var uploadAnime5:Bitmap;
		private var uploadAnime6:Bitmap;
		private var uploadAnime7:Bitmap;
		private var uploadAnime8:Bitmap;
		private var uploadAnimeFin:Bitmap;
		private var uploadAnimeErr:Bitmap;
		
		private var apos:uint = 1 ;
		private var delay:uint = 500;
		private var repeat:uint = 0;
		private var myTimer:Timer = new Timer(delay, repeat);
		
		public function DialogBox2(acceptFunction:Function = null) {
			...
			addChild(uploadAnime = new Bitmap()); //jun-ichi TAMURA 2017-12-27
			uploadAnime1 = new Bitmap();
			uploadAnime2 = new Bitmap();
			uploadAnime3 = new Bitmap();
			uploadAnime4 = new Bitmap();
			uploadAnime5 = new Bitmap();
			uploadAnime6 = new Bitmap();
			uploadAnime7 = new Bitmap();
			uploadAnime8 = new Bitmap();
			uploadAnimeFin = new Bitmap();
			uploadAnimeErr = new Bitmap();
			uploadAnime1.bitmapData = Resources.createBmp("ani01").bitmapData ;
			uploadAnime2.bitmapData = Resources.createBmp("ani02").bitmapData ;
			uploadAnime3.bitmapData = Resources.createBmp("ani03").bitmapData ;
			uploadAnime4.bitmapData = Resources.createBmp("ani04").bitmapData ;
			uploadAnime5.bitmapData = Resources.createBmp("ani05").bitmapData ;
			uploadAnime6.bitmapData = Resources.createBmp("ani06").bitmapData ;
			uploadAnime7.bitmapData = Resources.createBmp("ani07").bitmapData ;
			uploadAnime8.bitmapData = Resources.createBmp("ani08").bitmapData ;
			uploadAnimeFin.bitmapData = Resources.createBmp("aniFin").bitmapData ;
			uploadAnimeErr.bitmapData = Resources.createBmp("aniErr").bitmapData ;
			uploadAnime.bitmapData = uploadAnime1.bitmapData ;
			uploadAnime.x = 12;
			uploadAnime.y = 72;
			apos = 1;
...
*/
		...
		private function timerHandler(e:TimerEvent):void{
			if (apos == 1) {
				uploadAnime.bitmapData = uploadAnime2.bitmapData ;
				apos = 2;
				return ;
			}
			if (apos == 2) {
				uploadAnime.bitmapData = uploadAnime3.bitmapData ;
				apos = 3;
				return ;
			}
			if (apos == 3) {
				uploadAnime.bitmapData = uploadAnime4.bitmapData ;
				apos = 4;
				return ;
			}
			if (apos == 4) {
				uploadAnime.bitmapData = uploadAnime5.bitmapData ;
				apos = 5;
				return ;
			}
			if (apos == 5) {
				uploadAnime.bitmapData = uploadAnime6.bitmapData ;
				apos = 6;
				return ;
			}
			if (apos == 6) {
				uploadAnime.bitmapData = uploadAnime7.bitmapData ;
				apos = 7;
				return ;
			}
			if (apos == 7) {
				uploadAnime.bitmapData = uploadAnime8.bitmapData ;
				apos = 8;
				return ;
			}
			if (apos == 8) {
		...
		public function stopTimer():void {
			myTimer.stop(); 
			uploadAnime.bitmapData = uploadAnimeFin.bitmapData ;
			apos = 1;
		}

		public function stopTimer2():void {
			myTimer.stop(); 
			uploadAnime.bitmapData = uploadAnimeErr.bitmapData ;
			apos = 1;
		}
		...
		public static function ask(question:String, defaultAnswer:String, stage:Stage = null, resultFunction:Function = null):void {
			...
			var d:DialogBox2 = new DialogBox2(done);
			d.addTitle(question);
		...
		public static function confirm(question:String, stage:Stage = null, okFunction:Function = null):void {
			var d:DialogBox2 = new DialogBox2(okFunction);
			d.addTitle(question);
		...
		public static function findDialogBoxes(targetTitle:String, stage:Stage):Array {
			...
			for (var i:int = 0; i < stage.numChildren; i++) {
				var d:DialogBox2 = stage.getChildAt(i) as DialogBox2;
				if (d) {
					if (targetTitle) {
		...
		private function fixSize():void {
			...
			// title
			if (title != null) {
				w = Math.max(w, title.width) + 30; // 2018-01-15 jun-ichi TAMURA (+30pixel)
				h += 10 + title.height;
			}
			// fields
			maxLabelWidth = 0;
